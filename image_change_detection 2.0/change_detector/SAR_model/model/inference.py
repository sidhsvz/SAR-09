...
import torch
import numpy as np
from change_detector.SAR_model.model.build_model import Simple_CNN
from change_detector.SAR_model.kuang import sily
...
def main():
    test_img_path = '.\\dataset\\image_process'
    #test_img_path = "C:\\Users\\jsj31\\Desktop\\SAR-Change-Detection\\step3_test_dataset\\FarmlandD_test"
    model = '.\\change_detector\\SAR_model\\model\\checkpoints\\checkpoints_DCP9_val_0.005113.pth'
    use_gpu = 1
    ...
    for sub in all_sub_list:
        ...
        num += 1
        cv2.imwrite('.\\dataset\\result.bmp', result)
        sily()
        print(num)
